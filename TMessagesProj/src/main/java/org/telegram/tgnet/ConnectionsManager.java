...
//                return 0;
//            }
        if (((object instanceof TLRPC.TL_messages_readHistory) || (object instanceof TLRPC.TL_channels_readHistory)) && ApplicationLoader.INVISIBLE_MODE) {
            return 0;  //  unread
        }

        if ((object instanceof TLRPC.TL_messages_setTyping) && ApplicationLoader.TYPING_MODE) {
            return 0; // typing
        }
