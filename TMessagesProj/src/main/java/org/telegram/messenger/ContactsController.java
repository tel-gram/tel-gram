...
//        query.add(builder.build());
    ...
    public void initOnlineUsersSectionsDict() {
        ...
        for (String key : usersSectionsDict.keySet()) {
            ArrayList<TLRPC.TL_contact> onlineContacts = new ArrayList<>();
            for (Object o : ((ArrayList) this.usersSectionsDict.get(key))) {
            ...
            if (onlineContacts.size() > 0) {
                ...
                if (!this.onlineSortedUsersSectionsArray.contains(key)) {
                    this.onlineSortedUsersSectionsArray.add(key);
                }
            }
        }
