...
public class DrawerLayoutAdapter extends BaseAdapter {
    ...
    private int themesRow = 8;
    private int themingRow = 9;
    private int settingsRow = 10;
    private int channelRow = 11;
    private int communityRow = 12;
    private int findId = 13;
    private int myThemeId = 14;
    private int versionRow = 15;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == 0) {
            ...
            if (i == 2) {
                ...
                Drawable contacts = mContext.getResources().getDrawable(R.drawable.menu_contacts);
                contacts.setColorFilter(color, PorterDuff.Mode.SRC_IN);
                actionCell.setTextAndIcon(LocaleController.getString("onlineContacts", R.string.OnlineContacts), contacts);
            }/* else if (i == 7) {
                actionCell.setTextAndIcon(LocaleController.getString("InviteFriends", R.string.InviteFriends), R.drawable.menu_invite);
            }*/ else if (i == themesRow) {
                actionCell.setTextAndIcon(LocaleController.getString("DownloadThemes", R.string.DownloadThemes), R.drawable.menu_theming);
                ...
                actionCell.setTextAndIcon(LocaleController.getString("find Id", R.string.UsernameFinder), R.drawable.menu_forum);
            }else if(i== myThemeId){
                actionCell.setTextAndIcon(LocaleController.getString("Theming", R.string.themes), R.drawable.menu_forum);
            }
