...
public class OnlineContactsAdapter extends BaseSectionsAdapter {
    ...
    public Object getItem(int section, int position) {
        HashMap<String, ArrayList<TLRPC.TL_contact>> onlineUsersSectionsDict = onlyUsers == 2 ? ContactsController.getInstance().onlineUsersSectionsDict : ContactsController.getInstance().onlineUsersSectionsDict;
        ArrayList<String> onlineSortedUsersSectionsArray = onlyUsers == 2 ? ContactsController.getInstance().onlineSortedUsersSectionsArray : ContactsController.getInstance().onlineSortedUsersSectionsArray;
