...
public class MessageObject {
    ...
    public static TextPaint textPaintMedia = new TextPaint(Paint.ANTI_ALIAS_FLAG);
    ...
    public MessageObject(TLRPC.Message message, AbstractMap<Integer, TLRPC.User> users, AbstractMap<Integer, TLRPC.Chat> chats, boolean generateLayout) {
        ...
        textPaintLeft.setColor(themePrefs.getInt("chatLTextColor", def));
        textPaintLeft.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        textPaintRight.setColor(themePrefs.getInt("chatRTextColor", def));
        textPaintRight.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        textPaintMedia.setColor(themePrefs.getInt("chatRLinkColor", def));
        textPaintMedia.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        textPaintMedia.linkColor = themePrefs.getInt("chatRLinkColor", def);
        textPaintMedia.setTextSize(AndroidUtilities.dp(MessagesController.getInstance().fontSize));
